              ...
              >
                ...
                <div className='space-y-4'>
                  ...
                  <motion.button
                    ...
                    type='submit'
                    className='mt-6 inline-flex items-center justify-center bg-[#2D6DFF] min-w-[180px]  text-white rounded-full px-8 py-3 text-[18px] font-semibold hover:bg-gray-900 transition-all mt-8'
                  >
                    Send &nbsp; →
                  </motion.button>
                </div>
