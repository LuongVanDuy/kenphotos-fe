    ...
    <section className="bg-[#D4EFFF] overflow-hidden">
      <div className="max-w-content mx-auto px-4 py-8 md:py-[50px] text-center">
        ...
        <div className="relative w-full overflow-hidden">
          <div className="flex gap-4 md:gap-8 animate-marquee-right whitespace-nowrap">
            {[...media, ...media].map((item, idx) => (
              <div key={idx} className="flex-shrink-0  w-[113px] h-[75px] md:w-[145px] md:h-[97px] flex items-center justify-center">
                <Image
                  src={item.src}
                  alt={item.alt}
                  width={145}
