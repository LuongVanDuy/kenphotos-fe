    ...
    <section className="w-full bg-section pt-24">
      <div className="flex flex-col md:flex-row w-full min-h-[580px] py-16 md:py-0">
        <motion.div
          ...
          className="flex-1 flex items-center justify-center p-8 min-h-[200px] max-w-content"
        >
          <div className="text-center md:text-left max-w-2xl">
            <motion.h1
              ...
              className="text-[32px] md:text-[56px] font-semibold text-black-base leading-tight mb-6"
            >
              Software design
              <br />
            ...
            <motion.p
              ...
              className="text-base md:text-lg text-[#4B4B4B] "
            >
        ...
        <motion.div
          ...
          className="w-[100%] lg:w-[50%] flex-1 h-full p-4  md:px-16 pt-16 md:pb-32"
        >
          <Swiper
            modules={[Navigation]}
            navigation
