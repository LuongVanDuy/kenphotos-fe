...
const Following: React.FC = () => {
  return (
    <section className="bg-[#F1FFF4]">
      <div className="max-w-content mx-auto px-4 text-center">
        <h2 className="text-[25px] md:text-[45px] font-semibold normal-case not-italic no-underline py-[65px] leading-[1.2em] tracking-[0px] text-[#1C244B]">
