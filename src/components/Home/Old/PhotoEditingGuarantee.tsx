  ...
  return (
    <section className='bg-white py-16'>
      <div className='max-w-content mx-auto px-4'>
        <h2 className='text-[#1C244B] text-[25px] md:text-[45px] font-semibold text-center mb-12 leading-[1.2em] tracking-[0px] w-full mx-auto'>
          We will edit your photos first. You only pay after you are satisfied with the photos
          edited by us.
        </h2>
