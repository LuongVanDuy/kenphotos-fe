    ...
    <footer className='bg-[#151515] text-white pt-[20px]'>
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 min-h-[395px] pt-[10px]'>
          <div className='space-y-4 mx-auto text-center'>
            ...
            <p className='text-[15px]'>
              We make the most amazing, lively architectural photos that real estate photographers
              could find​
            </p>
          </div>
      ...
      <div className='flex flex-col md:flex-row justify-between items-center border-t md:border-none gap-4 p-[20px] mb-[65px] md:mb-0 border-gray-700 mt-3 text-white'>
        ...
        <div className='gap-8 text-[21px] font-bold flex-1 text-center justify-center hidden md:flex'>
          <Link href='/terms' className='hover:text-[#00A1F8] transition-colors'>
            TERMS & CONDITIONS
          </Link>
          <Link href='/privacy' className='hover:text-[#00A1F8] transition-colors'>
            PRIVACY POLICY
          </Link>
        </div>
      </div>
