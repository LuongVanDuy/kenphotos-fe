...
const HeroBanner = ({ fetchPublicServices, serviceList, serviceTotal, serviceLoading }: any) => {
        ...
        <div className='flex flex-col md:flex-row w-full min-h-[580px] pb-16 pt-3 md:py-0 gap-5 md:gap-0'>
          ...
          >
            <div className='text-center md:text-left'>
              ...
              >
                From precise color correction and realistic virtual staging to immersive 3D
                visualizations, True Color transforms ordinary property photos into powerful
                marketing visuals. Our fast turnaround and attention to detail help you attract more
