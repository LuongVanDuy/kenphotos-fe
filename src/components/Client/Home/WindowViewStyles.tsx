    ...
    <section className="py-10 md:py-[120px]">
      <div className="max-w-content mx-auto px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 justify-items-center items-start mt-12">
          <div className="flex flex-col border rounded-xl items-center justify-center p-2 lg:items-center min-h-[220px] w-full">
            <h3 className="text-[24px] md:text-[28px] font-semibold text-[#2C6BFF] mb-4 text-center lg:text-left">
              Window View Style
            </h3>
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <h3 className="text-[22px] leading-[30px] font-semibold text-[#161817] md:text-[24px] md:leading-[24px] p-4 text-center">
                {service.title}
              </h3>
            </div>
          ))}
