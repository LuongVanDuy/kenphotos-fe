...
const contactOrder = ['email', 'whatsapp', 'skype', 'telegram', 'facebook', 'address']
            ...
            <div className=' bg-white/60 dark:bg-slate-900/60 p-6 rounded-2xl shadow-sm'>
              <p className='text-slate-800 dark:text-slate-100 text-[16px] leading-relaxed'>
                ...
                <span className='block mt-3'>
                  Call us, email us, or send a message via the form below—our team will respond
              ...
              <div className='grid grid-cols-1 md:grid-cols-1 gap-4 mt-4'>
                {settingData?.contact &&
                  contactOrder.map((key) => {
                    ...
                    return (
                      <div key={key} className='flex items-center gap-4 group cursor-pointer'>
                        {icon}
                        {key === 'address' || key === 'telegram' || key === 'skype' ? (
