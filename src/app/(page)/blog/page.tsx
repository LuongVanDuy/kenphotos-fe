  ...
  return (
    <div className='max-w-content px-4 py-[50px] mx-auto'>
      ...
      <p className='text-center text-[14px] md:text-[18px] w-full  md:w-[60%] mx-auto'>
        Kenphotos.com’s team and other experts offer their best advice, insights, and how-to’s. All
        to help you improve the presentation of your property marketing.
      </p>
