...
import { fetchPublicPost } from "@/store/actions/posts";
...
const BlogDetailPage = ({ fetchPublicPost, postList, postTotal, postLoading }: any) => {
  ...
  return (
    <div className="max-w-content mx-auto px-4 py-16 text-center">
      ...
      <p className="text-base md:text-lg text-gray-600 mt-6 max-w-3xl mx-auto">
        Explore the possibilities of healthcare app development: must-have features, costs, app types, compliance rules, and much more.
      </p>
      <div className="mt-10 text-sm text-gray-500">
        Written by <span className="font-medium text-gray-700">Nhật Long</span> &nbsp;|&nbsp; Updated: Tháng 2 26, 2025
      </div>
      <div className="mt-16 w-full  aspect-[5/2] relative overflow-hidden rounded-xl shadow">
        <Image src="/images/blog-1.jpg" alt="Blog detail illustration" fill className="object-cover" priority />
      </div>
      ...
      <div className="relative flex gap-10 mt-16">
        ...
        <div className="hidden lg:flex flex-col gap-6 sticky top-32 h-fit text-gray-400">
          <a href="#" target="_blank" rel="noopener noreferrer" className="hover:text-black transition">
        ...
        <div className="flex-1 text-start m-auto w-full sm:max-w-[592px] md:max-w-[600px] lg:max-w-[690px] xl:max-w-[792px] mb-24">
          <p className="mb-5">
            If you’re stuck on a healthcare app idea and completely stuck, believe me, I get it. You’re excited, absolutely, but now confronted with a
            slate of questions. Where do you start? How do you even know what features are even going to be important? And HIPAA? Can you just Google
            it, or is it eventually going to bite you back?
          </p>
      ...
      <div>
        <h3 className="text-[20px] md:text-[44px]  text-start font-semibold  text-[#0D0D0D]">You may also like</h3>
