...
import ServiceSlider from "@/components/Home/Old/ServicesSlider";
...
const ServiceDetail = ({ params }: { params: { slug: string[] } }) => {
  ...
  return (
    <>
      <div className="max-w-content mx-auto px-4 pt-40 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-10 gap-10 items-start">
          {/* LEFT CONTENT */}
          <div className="md:col-span-4 text-left space-y-6">
            <div className="text-sm text-gray-500">
              <span className="hover:underline cursor-pointer">Services</span> / <span className="text-gray-800 font-medium">{slug}</span>
            </div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">📷 Single Exposure</h1>
            <p className="text-gray-700 text-[15px] leading-relaxed">
              Quickly and inexpensively transform a single exposure or pre-blended exposures into a refined, finished image. Vendors…
            </p>
              ...
              {accordionData.map((item, index) => {
                ...
                return (
                  <div key={index}>
                    ...
                    <div
                      className={`overflow-hidden bg-section transition-all duration-500 ease-in-out ${
