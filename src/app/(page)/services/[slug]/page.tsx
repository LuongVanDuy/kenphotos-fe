      ...
      <div className='grid grid-cols-1 md:grid-cols-10 gap-10 items-start'>
        ...
        <div className='md:col-span-4 text-left space-y-6'>
          ...
          <p className='text-gray-700 text-[15px] leading-relaxed'>
            Quickly and inexpensively transform a single exposure or pre-blended exposures into a
            refined, finished image. Vendors…
          </p>
            ...
            {services.map((service, index) => {
              return (
                <SwiperSlide key={`slide-${index}`}>
                  <div className='relative w-full h-[300px] md:h-[450px] rounded-xl overflow-hidden bg-gray-100 shadow-xl'>
                    <CompareSlider
