...
export const createOrder =
  (payload: any, accessToken: string, onSuccess: () => void, onFailure: (error: string) => void) =>
  async () => {
...
export const updateOrder =
  ...
  async () => {
    await asyncActionWrapper(
      () => putWithToken(orderEndpoint.updateOrder(payload.id), accessToken, payload.data),
      onSuccess,
      onFailure
    )
  }
...
export const permanentDeleteOrder =
  ...
  async () => {
    await asyncActionWrapper(
      () => deleteWithToken(orderEndpoint.permanentDeleteOrder(), accessToken, payload, null),
      onSuccess,
      onFailure
    )
  }

export const createPublicOrder =
  (payload: any, onSuccess: () => void, onFailure: (error: string) => void) => async () => {
    await asyncActionWrapper(
      () => postNoToken(orderEndpoint.createPublicOrder(), payload),
      onSuccess,
      onFailure
    )
  }
...
export const sendOrder =
  (orderId: number, onSuccess: () => void, onFailure: (error: string) => void) => async () => {
    await asyncActionWrapper(
      () => postNoToken(orderEndpoint.sendOrder(orderId), {}),
      onSuccess,
      onFailure
    )
  }
...
export const createContact =
  (payload: any, onSuccess: () => void, onFailure: (error: string) => void) => async () => {
    await asyncActionWrapper(
      () => postNoToken(orderEndpoint.createContact(), payload),
      onSuccess,
      onFailure
    )
  }
